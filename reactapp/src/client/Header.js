            ...
            <div class="container">
                <div class="row">
                    ...
                    <nav class="main-nav" style={{flexDirection: "row", marginLeft: "15%", marginRight: "15%"}}>
                        ...
                        <h4><span style={{color: "#000000"}}>LifeLine</span></h4>
                        </a>
                        ...
                        {/* <li class="scroll-to-section"><a href="#" class={currentTab == 2 && "active"} onClick={() => changeTab(2)}>Form</a></li> */}
                        <li class="scroll-to-section"><div class="main-red-button"><a href="index.html#portfolio"><b>Text +1 833 986 3290</b></a></div></li> 
                        </ul>        
